...
export interface IStorage {
  ...
  // Event operations
  getEvents(branchId?: number): Promise<Event[]>;
  ...
  // Post operations
  getPosts(branchId?: number): Promise<Post[]>;
  ...
  getActivityLogs(branchId?: number, limit?: number): Promise<ActivityLog[]>;
  createActivityLog(log: InsertActivityLog): Promise<ActivityLog>;
  
  // Analytics operations
  getEventStats(branchId?: number): Promise<any>;
  getSocialStats(branchId?: number): Promise<any>;
  getUserStats(branchId?: number): Promise<any>;
}
